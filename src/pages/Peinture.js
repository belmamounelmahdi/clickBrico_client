    ...
    <div>
        ...
        {jobberProfiles.map((ele, index) => (
            <div key={index} className="w-80 h-64 p-4 shadow-2xl m-8">
                <img className='w-24 h-24' src={ele.profile.photo && `data:${ele.profile.photo.contentType};base64,${ele.profile.photo.data.toString('base64')}`} alt="Profile Photo" />
