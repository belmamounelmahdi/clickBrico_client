...
function Inputs({name, placeholder, value, type, icon, handelChange, errors}) {
    ...
    <input className="peer bg-gray-100 p-2 pl-8 w-96 focus:outline-sky-600" value={value} type={type} name={name} onChange={handelChange} required placeholder={placeholder} errors={errors}/>
        {
